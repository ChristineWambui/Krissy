...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="exam.php"><i class="fa  fa-spinner"></i> <span>Pending</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    //perform deny here
      ...
      $denyquery="UPDATE clear SET status = 3 WHERE admission = $denyadmission AND departmentid = 2";
      $denyresults=mysqli_query($connection,$denyquery);
      if($denyresults)
      {
        echo "<script>
        alert('student denied clearance');
        window.location.href='examcleared.php';
        </script>
        ";
      }
      else{
      ...
      if($clearresults)
      {
        ...
        ";
		  ...
		  {
			  echo "<tr><td>No students cleared</tr></td>";
		  }
